...
solr:        mkdir -p tmp/solr/server/solr/blacklight-core/conf && cp solr/conf/*.xml tmp/solr/server/solr/blacklight-core/conf && bundle exec solr_wrapper --config .solr_wrapper.yml
