...
module BlacklightIiifSearch
  module AnnotationBehavior
    ...
    def annotation_id
      ...
      "https://cdm16022.contentdm.oclc.org/iiif/#{document[:id]}/annotation/a#{document[:child_index]}"
    end
    ...
    def canvas_uri_for_annotation
      ...
      "https://cdm16022.contentdm.oclc.org/iiif/#{document[:id]}/canvas/c#{document[:child_index]}" + coordinates
    end
